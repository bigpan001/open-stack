...
[`$setup-pstack`](../../skills/setup-pstack/SKILL.md) detects the models you have access to, shows you each role (code delegates, judgment, the review panels), and asks what you want. Answer the questions. It writes ``.codex/pstack-models.json` or `~/.codex/pstack-models.json``, a small rule every pstack skill reads.
