...
> Codex port status: retained as upstream reference only. This pack uses Cursor-specific automation webhooks and `.cursor/automations`; it is not registered or installed by the Codex plugin.
