...
- [ ] Arm the 30-minute audit tick. In a local session, a real terminal a Codex heartbeat automation. In a cloud root, a cloud-sleeper wake chain. Never leave the cadence to memory.
