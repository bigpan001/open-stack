...
- `inbox/` holds completion pointers. `gates.md` parks unresolved user decisions (question, options, and safe default when one exists) so completion updates cannot hide them.
